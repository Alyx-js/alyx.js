...
module.exports.userAgent = `DiscordBot (https://github.com/Alyx-js/alyx.js, ${require('../package.json').version})`;
...
module.exports.ENDPOINTS = {
 channel: (id) => `https://discord.com/api/v8/channels/${id}`,
 messages: (channelID) => `https://discord.com/api/v8/channels/${channelID}/messages`
}
